...
int main(int argc, char **argv)
{
  ...
  ROS_INFO("inicio de nodo tomarObjeto");
  ...
  ReceiveMsgFromAcercarseFino = nh_ptr_->subscribe<rcnn_live_detector::msgTomarObjeto>("goGrabTheObject", 1000, callBack);
